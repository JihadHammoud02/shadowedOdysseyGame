    ...
    public boolean  trade() {
        ...
        if (playerAnswer.equals("Y")) {
            if (player.getNbrePommes() > 0 && this.getRestQuantity() != 0) {
                System.out.println("I see you have an apples. I will take it for " + getApplePrice() + "xp,(Y/n)");
                playerAnswer = playerInput.nextLine();
                if (playerAnswer.equals("Y")) {
                ...
                System.out.println("Sorry I can't serve you anymore , you don't have any apples there");
            }
